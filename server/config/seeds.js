...
db.once('open', async () => {
  ...
  const products = await Product.insertMany([
    ...
    },
    {
      ...
      category: categories[0]._id,
      description:
        'Victoria - 4.09 Round White Sapphire Engagement Ring',
      image: 'R5.jpg',
      price: 150,
      quantity: 20
    }, {
      ...
      category: categories[0]._id,
      description:
        'Icon Round 4 Claw Diamond Solitaire Ring',
      image: 'R6.jpg',
      price: 199,
      quantity: 20
    },
    ...
    },
    {
      ...
      category: categories[2]._id,
      description:
        'Sed a mauris condientum, elementum enim in, rhoncus dui. Phasellus lobortis leo odio, sit amet pharetra turpis porta quis.',
      image: 'NP2.jpg',
      price: 299,
      quantity: 1000
    },
